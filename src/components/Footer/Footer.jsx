...
const Footer = () => {
  return (
    <footer className="bg-[#121926] text-white py-10 px-6 md:px-20 flex flex-col gap-8">
      {/* Top Section */}
      <div className="flex w-full flex-col md:flex-row justify-between items-center border-b border-gray-600 pb-6">
        <h2 className="text-xl md:text-2xl font-bold text-[#FACC15] tracking-wide">
          Voices of the Ancestors
        </h2>
        <p className="text-sm max-w-lg text-center md:text-left text-gray-200">
          Exploring African heritage through immersive storytelling and VR.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm">
        <div>
          <h3 className="text-[#FACC15] font-semibold pb-2">Explore</h3>
          <ul className="space-y-2">
            <li><a href="#" className="hover:text-[#FACC15] transition">Home</a></li>
            <li><a href="#" className="hover:text-[#FACC15] transition">Stories</a></li>
            <li><a href="#" className="hover:text-[#FACC15] transition">Library</a></li>
            <li><a href="#" className="hover:text-[#FACC15] transition">About Us</a></li>
          </ul>
        </div>
        <div>
          <h3 className="text-[#FACC15] font-semibold pb-2">Resources</h3>
          <ul className="space-y-2">
            <li><a href="#" className="hover:text-[#FACC15] transition">Blog</a></li>
            <li><a href="#" className="hover:text-[#FACC15] transition">FAQs</a></li>
            <li><a href="#" className="hover:text-[#FACC15] transition">Privacy Policy</a></li>
            <li><a href="#" className="hover:text-[#FACC15] transition">Terms & Conditions</a></li>
          </ul>
        </div>
        <div>
          <h3 className="text-[#FACC15] font-semibold pb-2">Stay Connected</h3>
          <div className="flex gap-4 mt-2">
            <a href="#" className="text-gray-200 hover:text-[#FACC15]"><FaFacebook size={20} /></a>
            <a href="#" className="text-gray-200 hover:text-[#FACC15]"><FaTwitter size={20} /></a>
            <a href="#" className="text-gray-200 hover:text-[#FACC15]"><FaInstagram size={20} /></a>
            <a href="#" className="text-gray-200 hover:text-[#FACC15]"><FaYoutube size={20} /></a>
          </div>
        </div>
        <div>
          <h3 className="text-[#FACC15] font-semibold pb-2">Newsletter</h3>
          <div className="flex items-center border border-gray-600 rounded-md overflow-hidden">
            ...
            />
            <button className="bg-[#FACC15] p-2"><MdEmail size={20} className="text-[#121926]" /></button>
          </div>
        </div>
      </div>

      {/* Bottom Section */}
      <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 border-t border-gray-600 pt-6">
        <p>© 2025 Voices of the Ancestors. All rights reserved.</p>
        <div className="flex items-center gap-2">
          <RiEarthFill size={18} className="text-[#FACC15]" />
          <select className="bg-transparent text-white border border-gray-600 rounded-md px-2 py-1 text-sm focus:outline-none">
            <option>English</option>
            <option>Swahili</option>
            <option>Igbo</option>
            <option>Yoruba</option>
